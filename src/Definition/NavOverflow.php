...
/**
 * @method $this enable(bool $enable = false) 是否开启响应式收纳
 * @method $this overflowLabel(string|array $overflowLabel) 菜单触发按钮的文字
 * @method $this overflowIndicator(string $overflowIndicator = 'fa fa-ellipsis') 菜单触发按钮的图标
 ...
 * @method $this mode(string $mode = 'popup') 导航超长时使用滚动模式还是浮层收纳模式，swipe 或 popup
 *
