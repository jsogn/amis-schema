 ...
 * @method $this placeholder(string $placeholder) 搜索框占位符
 * @method $this mini(bool $mini) 是否为 mini 模式
 * @method $this enhance(bool $enhance) 是否为增强样式
 * @method $this clearable(bool $clearable) 是否开启搜索
 * @method $this searchImediately(bool $searchImediately) 是否立即搜索
 *
